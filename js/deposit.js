...
// accept deposits from user, store deposits in array
    ...
    function btnDeposits(){
alert("hello");
let acctBalanceLbl = document.getElementById("#acctBalanceLbl");
// alert(acctBalanceLbl);
const deposits = [];

let totalBalance = 0;

const userDeposit = document.querySelector("#userDeposit");
...
function btnWithdraws(){

    let withdrawals = [];
let userWithdraw = document.querySelector("#userWithdraw");
